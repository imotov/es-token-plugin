...
public class TrainModelRequest extends ActionRequest<TrainModelRequest> {
    ...
    static {
        ...
        PARSER.declareObject(TrainModelRequest::setOutputField, ModelTargetField.PARSER, new ParseField("target"));
        PARSER.declareObjectArray(TrainModelRequest::setFields, ModelInputField.PARSER, new ParseField("inputs"));
    ...
    private List<ModelInputField> fields;
    ...
    public void setOutputField(ModelTargetField outputField) {
        this.outputField = outputField;
    }
    ...
    public ModelTargetField getOutputField() {
        return outputField;
    }
